...
const workoutData = {
            ...
            days: [
                {
                    dayName: 'Push Day',
                    focus: 'Chest, Shoulders, Triceps',
                    exercises: ['Bench Press', 'Dumbell Fly', 'Incline Bench Press', 'Shoulder Press', 'Tricep Extensions']
                },
                {
                    dayName: 'Pull Day',
                    focus: 'Chest Shoulders, Triceps',
                    exercises: ['Incline Dumbbell Press', 'Lat Pulldown', 'Cable Crossovers', 'Bicep Curls', 'Deadlift']
                },
                {
                    dayName: 'Leg Day',
    ...
    muscleGroups: [
        {
            groupName: 'Chest',
            exercises: ['Push-ups', 'Cable Flyes', 'Dumbbell Press', 'Decline Bench Press']
        },
        {
            groupName: 'Back',
        ...
        {
            groupName: 'Shoulders',
            exercises: ['Dumbell Lateral Raise', 'Dumbell Shoulder Press', 'Face Pull', 'Rear Delt Flys']
        },
        {
            groupName: 'Arms',
            exercises: ['Hammer Curl', 'Cable Curl', 'Tricep Pulldown', 'Skull Crushers']
        },
    ]
};
            ...
            <div style = {{ marginBottom: '40px '}}>
                ...
                {activeSplit !== null && activeDay !== null && (
                    <div>
                        ...
                        <p><strong>Focus:</strong> {workoutData.splits[activeSplit].days[activeDay].focus}</p>
                        <ul>
                            {workoutData.splits[activeSplit].days[activeDay].exercises.map((exercise, i) => (
            ...
            <div>
                ...
                {activeMuscle !== null && (
                    <div>
                        ...
                        <ul>
                            {workoutData.muscleGroups[activeMuscle].exercises.map((exercise, i) => (
                                <li key = {i}>{exercise}</li>
                            ))}
                        </ul>
                    </div>
